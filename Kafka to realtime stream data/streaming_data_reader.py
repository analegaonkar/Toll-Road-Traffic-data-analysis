...
TOPIC='toll'
DATABASE = '<write the databse here>'
USERNAME = '<write the username here>'
PASSWORD = '<write the passwod here>'

print("Connecting to the database")
try:
    connection = mysql.connector.connect(host="localhost", db=DATABASE, user=USERNAME, passwd=PASSWORD)
except Exception:
